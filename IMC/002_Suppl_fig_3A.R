...
##### Load data ####
load("I:/BEEN/Siddh/LCCO/Git_repositories/STS_final/analysis_files/IMC_summed_cell_populations.RData")

#### Supplementary figure 3A ####
# Boxplots of summed cell populations in low- and high-grade myxofibrosarcoma and USTS
ggboxplot(summed_counts, x = "grade", y = "sum_counts", fill = "Diagnosis")+ 
  ...
  scale_fill_manual(values = c("darkorchid", "darkgoldenrod3"), 
                    breaks = c("MFS", "USTS"))+
  scale_x_discrete(labels = c("Low grade MFS", "High grade MFS", "USTS"))+
  xlab(NULL)+
